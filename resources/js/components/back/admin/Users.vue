      ...
      <div class="col-12 mt-4 mx-auto" data-wow-delay="0.5s">
        ...
        <div class="table mx-auto" v-if="showAll">
          <div class="table-responsive">
            <table
              class="table table-bordered table-striped table-hover mx-auto text-center">
              <thead>
                <tr>
                ...
                <tr v-for="detail in paginatedData" :key="detail.id">
                  ...
                  <td data-label="Photo">
                    <img
                      ...
                      v-if="detail.profile_photo_path"
                      alt="utilisateur immobilier benin" />
                  ...
                  <td data-label="Actions">
                    <button
                      class="btn btn-danger m-1 text-white"
                      @click="displayBan(detail.id)">
        ...
        <div
          class="table mx-auto"
          v-if="showFiltered && filteredResults.length > 0">
          <div class="table-responsive">
            <table
              class="table table-bordered table-striped table-hover mx-auto text-center">
              <thead>
    ...
    <div class="col-sm-12 col-md-8 mx-auto" v-if="showBan">
      <div class="card p-3">
        <form @submit.prevent="ban">
          ...
          <p>
            {{ capitalizeFirstLetter(selectedDetail.first_name) }}
            {{ capitalizeFirstLetter(selectedDetail.last_name) }}
          </p>
