    ...
    <section class="container xxl">
        <div class="col-sm-12 col-md-8 mt-4 mx-auto">
                            <div class="bg-white border mt-2 rounded p-2 wow">
                                <form action="{{ url('/newAd') }}" method="POST" enctype='multipart/form-data'>
                                    @csrf
                                    <span class="ml-0" onclick="window.history.back();">
                                    ...
                                    <div class="row g-3 mt-4">
                                        <div class="col-sm-12 col-md-4 mx-auto text-center">
                                            <button class="btn btn-success w-100 py-3" type="submit">Ajouter</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
