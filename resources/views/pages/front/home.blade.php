    ...
    <div class="page active" id="page-home">
        ...
        <section class="hero" id="home">
            ...
            <div class="hero-container">
                <h1 class="hero-title">
                    Trouvez votre propriété de rêve au Bénin
                </h1>
                <p class="hero-subtitle">
                    Découvrez les meilleures opportunités immobilières avec notre plateforme moderne et intuitive. Maisons,
                    appartements, terrains - tout ce dont vous avez besoin pour votre projet.
                </p>
                <div class="hero-cta">
                    <a href="#" onclick="showPage('proprietes')" class="btn btn-primary">
                        <i class="fas fa-search"></i>
                        Explorer les propriétés
                    </a>
                    <a href="#" onclick="showPage('about')" class="btn btn-outline">
                ...
                <div class="search-card">
                    <div class="search-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Ville, quartier...">
                        </div>
                        <div class="form-group">
            ...
            <div class="container">
                <div class="section-header fade-in">
                    ...
                    <p class="section-subtitle">
                        Nous offrons une expérience immobilière exceptionnelle avec des services de qualité
                    </p>
                </div>
                <div class="features-grid">
                    <div class="feature-card fade-in">
                        ...
                        <p class="feature-description">
                            Trouvez exactement ce que vous cherchez avec nos filtres intelligents et notre système de
                            recherche avancé.
                        </p>
                    </div>
                    <div class="feature-card fade-in">
                        ...
                        <p class="feature-description">
                            Toutes nos transactions sont sécurisées et vérifiées pour votre tranquillité d'esprit.
                        </p>
                    </div>
                    <div class="feature-card fade-in">
                        <div class="feature-icon">
                        ...
                        <h3 class="feature-title">Agents experts</h3>
                        <p class="feature-description">
                            Notre équipe d'agents certifiés vous accompagne à chaque étape de votre projet immobilier.
                        </p>
                    </div>
                    <div class="feature-card fade-in">
                        <div class="feature-icon">
                        ...
                        <h3 class="feature-title">Plateforme moderne</h3>
                        <p class="feature-description">
                            Interface intuitive et responsive, accessible partout et à tout moment sur tous vos appareils.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="properties" id="properties">
            <div class="container">
                <div class="section-header fade-in">
                    <h2 class="section-title">Propriétés en vedette</h2>
                    <p class="section-subtitle">
            ...
            <div class="container">
                <div class="about-content">
                    <div class="about-text">
                        <h2>À propos d'ImmobilierBenin</h2>
                        <p>
                            Depuis plus de 10 ans, ImmobilierBenin est votre partenaire de confiance dans le secteur
                            immobilier béninois.
                            Nous mettons notre expertise au service de vos projets, qu'il s'agisse d'achat, de vente ou de
                            location.
                        </p>
                        <p>
                            Notre équipe d'agents certifiés vous accompagne avec professionnalisme et transparence pour
                            concrétiser
                            vos rêves immobiliers dans les meilleures conditions.
                        </p>
                        ...
                        <a href="#" onclick="showPage('contact')" class="btn btn-primary">
            ...
            <div class="container">
                ...
                <div class="contact-content">
                    <div class="contact-form">
                        <h3><i class="fas fa-envelope"></i> Envoyez-nous un message</h3>
                        <form>
                            <div class="form-group">
                    ...
                    <div class="contact-info">
                        <div class="contact-item">
                            ...
                            <div class="contact-details">
                                <h4>Adresse</h4>
                                <p>123 Avenue de l'Indépendance<br>Cotonou, Bénin</p>
                            </div>
                        </div>
                        <div class="contact-item">
                            <div class="contact-icon">
                            ...
                            <div class="contact-details">
                                <h4>Téléphone</h4>
                                <p>+229 XX XX XX XX<br>+229 YY YY YY YY</p>
                            </div>
                        </div>
                        <div class="contact-item">
                            <div class="contact-icon">
                            ...
                            <div class="contact-details">
                                <h4>Email</h4>
                                <p>contact@immobilierbenin.com<br>info@immobilierbenin.com</p>
                            </div>
                        </div>
                    </div>
                </div>
