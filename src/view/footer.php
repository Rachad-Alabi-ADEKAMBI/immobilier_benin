    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                ...
                <p class="mb-2"><i class="bi bi-phone me-3 text-blue"></i>+229 96 66 36 44</p>
                ...
                <p class="mb-2"><i class="bi bi-facebook me-3 text-blue"></i>Immobilier Bénin</p>
            </div>
            <div class="col-lg-4 col-md-6">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="row g-2 pt-2">
                    ...
                    <div class="col-4">
                        <img class="img-fluid rounded bg-light p-1" src="public/img/home2.jpeg"
                            alt="immobilier benin">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid rounded bg-light p-1" src="public/img/home4.jpeg"
                            alt="immobilier benin">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid rounded bg-light p-1" src="public/img/appart3.jpeg"
                            alt="immobilier benin">
                    </div>
                    <div class=" col-4">
                        <img class="img-fluid rounded bg-light p-1" src="public/img/bureaux3.jpeg"
                            alt="immobilier benin">
                    </div>
                </div>
            </div>
...
<!-- Back to Top -->
<a href="#apps" class="btn btn-lg btn-blue btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js" integrity="sha384-0pUGZvbkm6XF6gxjEnlmuGrJXVbNuzT9qBBavbLwCsOGabYfZo0T0to5eqruptLy" crossorigin="anonymous"></script>
 ...
 <style>
    .name{
        border-bottom: #8755F1 solid 1px;
    }
 </style>
