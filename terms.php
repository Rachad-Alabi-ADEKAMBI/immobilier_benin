...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="row g-0 gx-5 align-items-end">
                    ...
                    Bienvenue sur Immobilier Bénin. En utilisant notre site web, vous acceptez de respecter et d'être lié par les conditions d'utilisation suivantes. Veuillez les lire attentivement.
 <br>
...
En accédant ou en utilisant le site Immobilier Bénin, vous acceptez ces Conditions d'Utilisation et toutes les politiques ou directives incorporées par référence. Si vous n'acceptez pas toutes ces conditions, veuillez ne pas utiliser notre site.
...
4. Contenu du Site
    ...
    Propriété Intellectuelle: Tous les contenus du site, y compris les textes, graphiques, logos, images et logiciels, sont la propriété de Immobilier Bénin ou de ses fournisseurs de contenu et sont protégés par les lois sur la propriété intellectuelle.
...
5. Annonces et Propriétés
    ...
    Responsabilité: Immobilier Bénin décline toute responsabilité concernant les transactions ou interactions entre les utilisateurs et les annonceurs de propriétés.
...
6. Limitation de Responsabilité
    ...
    Exonération de Responsabilité: En aucun cas, Immobilier Bénin ne pourra être tenu responsable des dommages indirects, accessoires, spéciaux ou consécutifs découlant de l'utilisation ou de l'impossibilité d'utiliser le site.
